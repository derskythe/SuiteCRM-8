...
class PackageManagerDisplay
{
    ...
    public static function buildPackageDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1', $install = false)
    {
        ...
        $form2 .= "</td><td align='left'><div id='workingStatusDiv' style='display:none;'>".SugarThemeRegistry::current()->getImage(
                'sqsWait', "border='0' align='bottom'", null, null, '.gif',
                'Loading'
    ...
    public function buildPatchDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1')
    {
        ...
        $form2 .= "</td><td align='right'><div id='workingStatusDiv' style='display:none;'>".SugarThemeRegistry::current()->getImage(
                'sqsWait', "border='0' align='bottom'", null, null, '.gif',
                'Loading'
    ...
    */
    ...
    public static function getDisplayScript($install = false, $type = 'module', $releases = null, $types = array(), $isAlive = true)
    {
        ...
        $ss->assign('WAIT_IMAGE', SugarThemeRegistry::current()->getImage(
            'loading', "border='0' align='bottom'", null, null, '.gif',
            'Loading'
        ));
