...
class SugarWidgetFieldFloat extends SugarWidgetFieldInt
{
    ...
    {
        return $this->_get_column_select($layout_def) . ' BETWEEN ' . DBManagerFactory::getInstance()->quote(
                unformat_number($layout_def['input_name0'])
            ) . ' AND ' . DBManagerFactory::getInstance()->quote(unformat_number($layout_def['input_name1'])) . "\n";
    }
}
