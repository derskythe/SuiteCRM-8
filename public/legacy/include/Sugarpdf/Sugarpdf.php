...
if (file_exists(__DIR__ . '/../../custom/include/Sugarpdf/sugarpdf_config.php')) {
    require_once(__DIR__ . '/../../custom/include/Sugarpdf/sugarpdf_config.php');
} else {
    require_once(__DIR__ . '/../../include/Sugarpdf/sugarpdf_config.php');
}

require_once(__DIR__ . '/../../include/tcpdf/tcpdf.php');
require_once(__DIR__ . '/../../include/Sugarpdf/SugarpdfHelper.php');
...
class Sugarpdf extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->SetLineStyle(
            array( 'width' => 0.85 / $this->getScaleFactor(),
                   'cap'   => 'butt',
                   'join'  => 'miter',
                   'dash'  => 0,
                   'color' => array( 0, 0, 0 ) )
    ...
    public function Ln1()
    {
        $this->Ln($this->FontSize * $this->cell_height_ratio + 2 * $this->cMargin, false);
    }
        ...
        if (!isset($options['isheader']) || $options['isheader']) {
            ...
            foreach ($header as $v) {
                $this->MultiCell(
                    ...
                    $headerOptions['align'],
                    $headerOptions['fillstate'],
                    0,
                    '',
                    '',
                    true,
                    $options['stretch'][$v],
                    $headerOptions['ishtml']
                );
            }
