...
require_once(__DIR__.'/../../include/Sugarpdf/sugarpdf_default.php');
if (file_exists(__DIR__.'/../../custom/include/Sugarpdf/sugarpdf_default.php')) {
    require_once(__DIR__.'/../../custom/include/Sugarpdf/sugarpdf_default.php');
}
// set alternative config file
if (!defined('K_TCPDF_EXTERNAL_CONFIG')) {

    global $sugarpdf_default;
    /*
...
function defineFromConfig($value, $default)
{
    ...
    $element = 'sugarpdf_' . $lowerValue;
    if (isset($focus->settings[$element])) {
        define($value, $focus->settings[$element]);
    } else {
...
function defineFromUserPreference($value, $default)
{
    ...
    if (defined('SUGARPDF_USE_FOCUS')) {
        $pref = $focus_user->getPreference($element);
    } else {
        $pref = $current_user->getPreference($element);
    }
    if (str_contains($value, 'PDF_FONT_NAME_')) {
        require_once(__DIR__.'/../../include/Sugarpdf/FontManager.php');
