   ...
   public function drawStockChart($Format= '')
    {
     ...
     $BoxUpSettings    = array( 'R'           =>$BoxUpR, 'G' =>$BoxUpG, 'B' =>$BoxUpB, 'Alpha' =>$BoxUpAlpha, 'BorderR' =>$BoxUpBorderR, 'BorderG' =>$BoxUpBorderG, 'BorderB' =>$BoxUpBorderB,
                                'BorderAlpha' =>$BoxUpBorderAlpha);
     $BoxDownSettings    = array( 'R'           =>$BoxDownR, 'G' =>$BoxDownG, 'B' =>$BoxDownB, 'Alpha' =>$BoxDownAlpha, 'BorderR' =>$BoxDownBorderR, 'BorderG' =>$BoxDownBorderG, 'BorderB' =>$BoxDownBorderB,
