   ...
   public function drawBubbleChart($DataSeries,$WeightSeries,$Format= '')
    {
     ...
     if ( isset($Data['Series']['BubbleFakePositiveSerie'] ) ) { $this->pDataObject->setSerieDrawable(
         'BubbleFakePositiveSerie', FALSE); }
     if ( isset($Data['Series']['BubbleFakeNegativeSerie'] ) ) { $this->pDataObject->setSerieDrawable(
         'BubbleFakeNegativeSerie', FALSE); }
     ...
     foreach($DataSeries as $Key => $SerieName)
      {
       ...
       $Color = array( 'R'     => $Palette[$Key]['R'], 'G' => $Palette[$Key]['G'], 'B' => $Palette[$Key]['B'],
   ...
   public function writeBubbleLabel($SerieName,$SerieWeightName,$Points,$Format= '')
    {
     ...
     $Color = array( 'R'     => $Data['Series'][$SerieName]['Color']['R'], 'G' => $Data['Series'][$SerieName]['Color']['G'], 'B' => $Data['Series'][$SerieName]['Color']['B'],
