     ...
     foreach($Data['Axis'] as $AxisID => $AxisSettings)
      {
       ...
       if ( isset($ManualScale[$AxisID]['Rows']) && isset($ManualScale[$AxisID]['RowHeight']) )
        $Scale = array( 'Rows' => $ManualScale[$AxisID]['Rows'], 'RowHeight' => $ManualScale[$AxisID]['RowHeight'], 'XMin' => $ManualScale[$AxisID]['Min'],
       ...
       if ( isset($AxisSettings['Color']) )
        {
         ...
         $this->pChartObject->setFontProperties(array( 'R' => $AxisSettings['Color']['R'], 'G' => $AxisSettings['Color']['G'],
         ...
         if ($AxisSettings['Position'] == AXIS_POSITION_BOTTOM )
          {
           ...
           if ( $Floating )
            { $FloatingOffset = $YMargin; $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1+ $AxisSettings['Margin'], $AxisPos['B'], $this->pChartObject->GraphAreaX2- $AxisSettings['Margin'], $AxisPos['B'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                                                                                   'Alpha' =>$AxisAlpha)); }
           else
            { $FloatingOffset = 0; $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1, $AxisPos['B'], $this->pChartObject->GraphAreaX2, $AxisPos['B'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                          'Alpha' =>$AxisAlpha)); }

           if ( $DrawArrows ) { $this->pChartObject->drawArrow($this->pChartObject->GraphAreaX2- $AxisSettings['Margin'], $AxisPos['B'], $this->pChartObject->GraphAreaX2+($ArrowSize*2), $AxisPos['B'], array( 'FillR' =>$AxisR, 'FillG' =>$AxisG, 'FillB' =>$AxisB,
                                                                                                                                                                                                                'Size'  =>$ArrowSize)); }
           ...
           for($i=0; $i<= $AxisSettings['Rows']; $i++)
            {
             ...
             if ( $i%2 == 1 ) { $BGColor = array( 'R'     =>$BackgroundR1, 'G' =>$BackgroundG1, 'B' =>$BackgroundB1,
                                                  'Alpha' =>$BackgroundAlpha1); } else { $BGColor = array( 'R'     =>$BackgroundR2, 'G' =>$BackgroundG2, 'B' =>$BackgroundB2,
                                                                                                           'Alpha' =>$BackgroundAlpha2); }
                if ($LastX != null && $CycleBackground && ($DrawXLines == ALL || in_array(
                            $AxisID,
                            $DrawXLines,
                            true
                        ))) {
                ...
                if ($DrawXLines == ALL || in_array($AxisID, $DrawXLines, true)) {
             ...
             if ( $DrawSubTicks && $i != $AxisSettings['Rows'] )
              $this->pChartObject->drawLine($XPos+$SubTicksSize,$YPos-$InnerSubTickWidth,$XPos+$SubTicksSize,$YPos+$OuterSubTickWidth,array( 'R'     =>$SubTickR, 'G' =>$SubTickG, 'B' =>$SubTickB,
                                                                                                                                             'Alpha' =>$SubTickAlpha));

             $this->pChartObject->drawLine($XPos,$YPos-$InnerTickWidth,$XPos,$YPos+$OuterTickWidth,array( 'R'     =>$TickR, 'G' =>$TickG, 'B' =>$TickB,
                                                                                                          'Alpha' =>$TickAlpha));
             $Bounds    = $this->pChartObject->drawText($XPos,$YPos+$OuterTickWidth+$LabelOffset,$Value,array( 'Angle' =>$XLabelsRotation,
                                                                                                               'Align' =>$LabelAlign));
         ...
         elseif ($AxisSettings['Position'] == AXIS_POSITION_TOP )
          {
           ...
           if ( $Floating )
            { $FloatingOffset = $YMargin; $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1+ $AxisSettings['Margin'], $AxisPos['T'], $this->pChartObject->GraphAreaX2- $AxisSettings['Margin'], $AxisPos['T'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                                                                                   'Alpha' =>$AxisAlpha)); }
           else
            { $FloatingOffset = 0; $this->pChartObject->drawLine($this->pChartObject->GraphAreaX1, $AxisPos['T'], $this->pChartObject->GraphAreaX2, $AxisPos['T'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                          'Alpha' =>$AxisAlpha)); }

           if ( $DrawArrows ) { $this->pChartObject->drawArrow($this->pChartObject->GraphAreaX2- $AxisSettings['Margin'], $AxisPos['T'], $this->pChartObject->GraphAreaX2+($ArrowSize*2), $AxisPos['T'], array( 'FillR' =>$AxisR, 'FillG' =>$AxisG, 'FillB' =>$AxisB,
                                                                                                                                                                                                                'Size'  =>$ArrowSize)); }
           ...
           for($i=0; $i<= $AxisSettings['Rows']; $i++)
            {
             ...
             if ( $DrawSubTicks && $i != $AxisSettings['Rows'] )
              $this->pChartObject->drawLine($XPos+$SubTicksSize,$YPos-$OuterSubTickWidth,$XPos+$SubTicksSize,$YPos+$InnerSubTickWidth,array( 'R'     =>$SubTickR, 'G' =>$SubTickG, 'B' =>$SubTickB,
                                                                                                                                             'Alpha' =>$SubTickAlpha));

             $this->pChartObject->drawLine($XPos,$YPos-$OuterTickWidth,$XPos,$YPos+$InnerTickWidth,array( 'R'     =>$TickR, 'G' =>$TickG, 'B' =>$TickB,
                                                                                                          'Alpha' =>$TickAlpha));
             $Bounds = $this->pChartObject->drawText($XPos,$YPos-$OuterTickWidth-$LabelOffset,$Value,array( 'Angle' =>$XLabelsRotation,
                                                                                                            'Align' =>$LabelAlign));
         ...
         if ($AxisSettings['Position'] == AXIS_POSITION_LEFT )
          {
           ...
           if ( $Floating )
            { $FloatingOffset = $XMargin; $this->pChartObject->drawLine($AxisPos['L'], $this->pChartObject->GraphAreaY1+ $AxisSettings['Margin'], $AxisPos['L'], $this->pChartObject->GraphAreaY2- $AxisSettings['Margin'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                                                                                   'Alpha' =>$AxisAlpha)); }
           else
            { $FloatingOffset = 0; $this->pChartObject->drawLine($AxisPos['L'], $this->pChartObject->GraphAreaY1, $AxisPos['L'], $this->pChartObject->GraphAreaY2, array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                          'Alpha' =>$AxisAlpha)); }

           if ( $DrawArrows ) { $this->pChartObject->drawArrow($AxisPos['L'], $this->pChartObject->GraphAreaY1+ $AxisSettings['Margin'], $AxisPos['L'], $this->pChartObject->GraphAreaY1-($ArrowSize*2), array( 'FillR' =>$AxisR, 'FillG' =>$AxisG, 'FillB' =>$AxisB,
                                                                                                                                                                                                                'Size'  =>$ArrowSize)); }
           ...
           for($i=0; $i<= $AxisSettings['Rows']; $i++)
            {
             ...
             if ( $i%2 == 1 ) { $BGColor = array( 'R'     =>$BackgroundR1, 'G' =>$BackgroundG1, 'B' =>$BackgroundB1,
                ...
                if (($YPos != $this->pChartObject->GraphAreaY1 && $YPos != $this->pChartObject->GraphAreaY2) && ($DrawYLines == ALL || in_array(
                            $AxisID,
                            $DrawYLines,
                            true
                        ))) {
             ...
             if ( $DrawSubTicks && $i != $AxisSettings['Rows'] )
              $this->pChartObject->drawLine($XPos-$OuterSubTickWidth,$YPos-$SubTicksSize,$XPos+$InnerSubTickWidth,$YPos-$SubTicksSize,array( 'R'     =>$SubTickR, 'G' =>$SubTickG, 'B' =>$SubTickB,
                                                                                                                                             'Alpha' =>$SubTickAlpha));

             $this->pChartObject->drawLine($XPos-$OuterTickWidth,$YPos,$XPos+$InnerTickWidth,$YPos,array( 'R'     =>$TickR, 'G' =>$TickG, 'B' =>$TickB,
                                                                                                          'Alpha' =>$TickAlpha));
         ...
         elseif ($AxisSettings['Position'] == AXIS_POSITION_RIGHT )
          {
           ...
           if ( $Floating )
            { $FloatingOffset = $XMargin; $this->pChartObject->drawLine($AxisPos['R'], $this->pChartObject->GraphAreaY1+ $AxisSettings['Margin'], $AxisPos['R'], $this->pChartObject->GraphAreaY2- $AxisSettings['Margin'], array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                                                                                   'Alpha' =>$AxisAlpha)); }
           else
            { $FloatingOffset = 0; $this->pChartObject->drawLine($AxisPos['R'], $this->pChartObject->GraphAreaY1, $AxisPos['R'], $this->pChartObject->GraphAreaY2, array( 'R'     =>$AxisR, 'G' =>$AxisG, 'B' =>$AxisB,
                                                                                                                                                                          'Alpha' =>$AxisAlpha)); }

           if ( $DrawArrows ) { $this->pChartObject->drawArrow($AxisPos['R'], $this->pChartObject->GraphAreaY1+ $AxisSettings['Margin'], $AxisPos['R'], $this->pChartObject->GraphAreaY1-($ArrowSize*2), array( 'FillR' =>$AxisR, 'FillG' =>$AxisG, 'FillB' =>$AxisB,
                                                                                                                                                                                                                'Size'  =>$ArrowSize)); }
           ...
           for($i=0; $i<= $AxisSettings['Rows']; $i++)
            {
             ...
             if ( $DrawSubTicks && $i != $AxisSettings['Rows'] )
              $this->pChartObject->drawLine($XPos-$InnerSubTickWidth,$YPos-$SubTicksSize,$XPos+$OuterSubTickWidth,$YPos-$SubTicksSize,array( 'R'     =>$SubTickR, 'G' =>$SubTickG, 'B' =>$SubTickB,
                                                                                                                                             'Alpha' =>$SubTickAlpha));

             $this->pChartObject->drawLine($XPos-$InnerTickWidth,$YPos,$XPos+$OuterTickWidth,$YPos,array( 'R'     =>$TickR, 'G' =>$TickG, 'B' =>$TickB,
                                                                                                          'Alpha' =>$TickAlpha));
       ...
       if ($Series['isDrawable'] == TRUE )
        {
         ...
         $Color = array( 'R'     => $Series['Color']['R'], 'G' => $Series['Color']['G'], 'B' => $Series['Color']['B'],
       ...
       if ($Series['isDrawable'] == TRUE )
        {
         ...
         $SplineSettings = array( 'R'     => $Series['Color']['R'], 'G' => $Series['Color']['G'], 'B' => $Series['Color']['B'],
                                  'Alpha' => $Series['Color']['Alpha']);
   ...
   public function drawScatterLegend($X,$Y,$Format= '')
    {
     ...
     if ( $Style == LEGEND_ROUND )
      $this->pChartObject->drawRoundedFilledRectangle($Boundaries['L']-$Margin, $Boundaries['T']-$Margin, $Boundaries['R']+$Margin, $Boundaries['B']+$Margin, $Margin, array( 'R'       =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha, 'BorderR' =>$BorderR, 'BorderG' =>$BorderG,
                                                                                                                                                                              'BorderB' =>$BorderB));
     elseif ( $Style == LEGEND_BOX )
      $this->pChartObject->drawFilledRectangle($Boundaries['L']-$Margin, $Boundaries['T']-$Margin, $Boundaries['R']+$Margin, $Boundaries['B']+$Margin, array( 'R'       =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha, 'BorderR' =>$BorderR, 'BorderG' =>$BorderG,
                                                                                                                                                              'BorderB' =>$BorderB));
           ...
           if ( $Family == LEGEND_FAMILY_BOX )
            {
             ...
             $this->pChartObject->drawFilledRectangle($X+1+$XOffset,$Y+1+$YOffset,$X+$BoxWidth+$XOffset+1,$Y+$BoxHeight+1+$YOffset,array( 'R'     =>0, 'G' =>0, 'B' =>0,
                                                                                                                                          'Alpha' =>20));
             $this->pChartObject->drawFilledRectangle($X+$XOffset,$Y+$YOffset,$X+$BoxWidth+$XOffset,$Y+$BoxHeight+$YOffset,array( 'R'           =>$R, 'G' =>$G, 'B' =>$B,
                                                                                                                                  'Surrounding' =>20));
            }
           elseif ( $Family == LEGEND_FAMILY_CIRCLE )
            {
             $this->pChartObject->drawFilledCircle($X+1+$IconAreaWidth/2,$Y+1+$IconAreaHeight/2,min($IconAreaHeight/2,$IconAreaWidth/2),array( 'R'     =>0, 'G' =>0, 'B' =>0,
                                                                                                                                               'Alpha' =>20));
             $this->pChartObject->drawFilledCircle($X+$IconAreaWidth/2,$Y+$IconAreaHeight/2,min($IconAreaHeight/2,$IconAreaWidth/2),array( 'R'           =>$R, 'G' =>$G, 'B' =>$B,
                                                                                                                                           'Surrounding' =>20));
            }
           elseif ( $Family == LEGEND_FAMILY_LINE )
            {
             $this->pChartObject->drawLine($X+1,$Y+1+$IconAreaHeight/2,$X+1+$IconAreaWidth,$Y+1+$IconAreaHeight/2,array( 'R'      =>0, 'G' =>0, 'B' =>0, 'Alpha' =>20, 'Ticks' =>$Ticks,
                                                                                                                         'Weight' =>$Weight));
             $this->pChartObject->drawLine($X,$Y+$IconAreaHeight/2,$X+$IconAreaWidth,$Y+$IconAreaHeight/2,array( 'R'      =>$R, 'G' =>$G, 'B' =>$B, 'Ticks' =>$Ticks,
                                                                                                                 'Weight' =>$Weight));
            }
          }
         ...
         if ( $Mode == LEGEND_VERTICAL )
          {
           $Lines = preg_split("/\n/",(string) $Series['Description']);
           foreach($Lines as $Key => $Value)
            $this->pChartObject->drawText($X+$IconAreaWidth+4,$Y+$IconAreaHeight/2+(($this->pChartObject->FontSize+3)*$Key),$Value,array( 'R'     =>$FontR, 'G' =>$FontG, 'B' =>$FontB,
         ...
         elseif ( $Mode == LEGEND_HORIZONTAL )
          {
           ...
           foreach($Lines as $Key => $Value)
            {
             $BoxArray = $this->pChartObject->drawText($X+$IconAreaWidth+4,$Y+$IconAreaHeight/2+(($this->pChartObject->FontSize+3)*$Key),$Value,array( 'R'     =>$FontR, 'G' =>$FontG, 'B' =>$FontB,
                                                                                                                                                       'Align' =>TEXT_ALIGN_MIDDLELEFT));
             $Width[] = $BoxArray[1]['X'];
            }
           $X=max($Width)+2+$XStep;
       ...
       if ( isset($PosArrayX[$Point]) && isset($PosArrayY[$Point]) )
        {
         ...
         if ( $DrawPoint == LABEL_POINT_CIRCLE )
          $this->pChartObject->drawFilledCircle($X,$Y,3,array( 'R'       =>255, 'G' =>255, 'B' =>255, 'BorderR' =>0, 'BorderG' =>0,
                                                               'BorderB' =>0));
         elseif ( $DrawPoint == LABEL_POINT_BOX )
          $this->pChartObject->drawFilledRectangle($X-2,$Y-2,$X+2,$Y+2,array( 'R'       =>255, 'G' =>255, 'B' =>255, 'BorderR' =>0, 'BorderG' =>0,
                                                                              'BorderB' =>0));
     ...
     if ($Data['Axis'][$AxisID]['Identity'] == AXIS_Y )
      {
       ...
       $this->pChartObject->drawLine($X1,$Y,$X2,$Y,array( 'R'      =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha, 'Ticks' =>$Ticks,
                                                          'Weight' =>$Weight));

       if ( $Wide )
        {
         $this->pChartObject->drawLine($X1,$Y-1,$X2,$Y-1,array( 'R'     =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha/$WideFactor,
                                                                'Ticks' =>$Ticks));
         $this->pChartObject->drawLine($X1,$Y+1,$X2,$Y+1,array( 'R'     =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha/$WideFactor,
                                                                'Ticks' =>$Ticks));
        }
     ...
     elseif ($Data['Axis'][$AxisID]['Identity'] == AXIS_X )
      {
       ...
       $this->pChartObject->drawLine($X,$Y1,$X,$Y2,array( 'R'      =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha, 'Ticks' =>$Ticks,
                                                          'Weight' =>$Weight));

       if ( $Wide )
        {
         $this->pChartObject->drawLine($X-1,$Y1,$X-1,$Y2,array( 'R'     =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha/$WideFactor,
                                                                'Ticks' =>$Ticks));
         $this->pChartObject->drawLine($X+1,$Y1,$X+1,$Y2,array( 'R'     =>$R, 'G' =>$G, 'B' =>$B, 'Alpha' =>$Alpha/$WideFactor,
                                                                'Ticks' =>$Ticks));
        }
     ...
     if ($Data['Axis'][$AxisID]['Identity'] == AXIS_X )
      {
       ...
       if ( $Border )
        {
         $this->pChartObject->drawLine($X1,$Y1,$X1,$Y2,array( 'R'     =>$BorderR, 'G' =>$BorderG, 'B' =>$BorderB, 'Alpha' =>$BorderAlpha,
                                                              'Ticks' =>$BorderTicks));
         $this->pChartObject->drawLine($X2,$Y1,$X2,$Y2,array( 'R'     =>$BorderR, 'G' =>$BorderG, 'B' =>$BorderB, 'Alpha' =>$BorderAlpha,
                                                              'Ticks' =>$BorderTicks));
        }
       ...
       if ( $AreaName != NULL )
        {
         ...
         $this->pChartObject->drawText($XPos,$YPos,$AreaName,array( 'R'     =>$NameR, 'G' =>$NameG, 'B' =>$NameB, 'Alpha' =>$NameAlpha, 'Angle' =>$NameAngle,
     ...
     elseif ($Data['Axis'][$AxisID]['Identity'] == AXIS_Y )
      {
       ...
       if ( $Border )
        {
         $this->pChartObject->drawLine($X1,$Y1,$X2,$Y1,array( 'R'     =>$BorderR, 'G' =>$BorderG, 'B' =>$BorderB, 'Alpha' =>$BorderAlpha,
                                                              'Ticks' =>$BorderTicks));
         $this->pChartObject->drawLine($X1,$Y2,$X2,$Y2,array( 'R'     =>$BorderR, 'G' =>$BorderG, 'B' =>$BorderB, 'Alpha' =>$BorderAlpha,
                                                              'Ticks' =>$BorderTicks));
        }
       ...
       if ( $AreaName != NULL )
        {
         ...
         $this->pChartObject->Shadow = $RestoreShadow;
         $this->pChartObject->drawText($YPos,$XPos,$AreaName,array( 'R'     =>$NameR, 'G' =>$NameG, 'B' =>$NameB, 'Alpha' =>$NameAlpha, 'Angle' =>0,
                                                                    'Align' =>TEXT_ALIGN_MIDDLEMIDDLE));
