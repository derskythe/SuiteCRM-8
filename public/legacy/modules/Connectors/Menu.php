...
if (in_array($GLOBALS['action'], $actions, true)) {
    $module_menu[]=array( 'index.php?module=Connectors&action=ConnectorSettings', $mod_strings['LBL_ADMINISTRATION_MAIN'],
                          'icon_Connectors' );
    $module_menu[]=array( 'index.php?module=Connectors&action=ModifyProperties', $mod_strings['LBL_MODIFY_PROPERTIES_TITLE'],
                          'icon_ConnectorConfig_16' );
    $module_menu[]=array( 'index.php?module=Connectors&action=ModifyDisplay', $mod_strings['LBL_MODIFY_DISPLAY_TITLE'],
                          'icon_ConnectorEnable_16' );
    $module_menu[]=array( 'index.php?module=Connectors&action=ModifyMapping', $mod_strings['LBL_MODIFY_MAPPING_TITLE'],
