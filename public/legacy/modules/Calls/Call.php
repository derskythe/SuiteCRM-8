...
class Call extends SugarBean
{
    ...
    public array $additional_column_fields = array( 'assigned_user_name', 'assigned_user_id', 'contact_id', 'user_id', 'contact_name');
    public array $relationship_fields = array( 'account_id'       => 'accounts',
    ...
    */
    ...
    public function create_export_query(string $order_by, string $where) : array|string
    {
        ...
        if ($contact_required) {
            ...
            $where_auto =
                'calls_contacts.contact_id = contacts.id AND calls_contacts.call_id = calls.id AND calls.deleted=0 AND contacts.deleted=0';
        } else {
