...
class Employee extends Person
{
    ...
    public function __construct()
    {
        ...
        $this->module_dir = 'Employees';
        $this->table_name = 'users';
        $this->object_name = 'Employee';
    ...
    public function fill_in_additional_detail_fields()
    {
        ...
        if ($row != null) {
            $this->reports_to_name =
                stripslashes($locale->getLocaleFormattedName($row['first_name'], $row['last_name']));
        } else {
            $this->reports_to_name = '';
        }
    }
    ...
    public function get_list_view_data()
    {
        ...
        if (isset($GLOBALS['app_list_strings']['employee_status_dom'][$this->employee_status])) {
            $user_fields['EMPLOYEE_STATUS'] =
                $GLOBALS['app_list_strings']['employee_status_dom'][$this->employee_status];
        }
    ...
    {
        global $current_user, $fields_array;
            ...
            if (!is_admin($current_user)) {
                if ($this->id && $current_user->id != $this->id) {
                    $GLOBALS['log']->security(
                        "{$current_user->name} tried to update {$this->name} record with out permission."
                    );
